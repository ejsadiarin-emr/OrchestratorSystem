...
const mockLogs: MiniLogLine[] = [
  { id: '1', at: '01:05:23', level: 'info', message: 'Starting workload deployment for node fleet-001' },
  ...
  { id: '4', at: '01:06:34', level: 'warn', message: 'Retrying connection to node fleet-003 (attempt 2/3)' },
  ...
  { id: '7', at: '01:07:45', level: 'info', message: 'Rollback initiated for node fleet-002' },
]

export default function CommandCenter() {
  const [logSheetOpen, setLogSheetOpen] = useState(false)
  const [selectedNodeId, setSelectedNodeId] = useState('fleet-001')

  const metrics = [
    { label: 'Fleet Online / Offline', value: '12 / 3' },
