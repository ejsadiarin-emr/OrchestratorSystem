...
**Rationale:**
- **Silent misconfiguration risk:** A package not in the registry would silently default to `InPlace`, potentially causing the exact side-by-side bug this system is designed to prevent.
